(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function a(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function o(r){if(r.ep)return;r.ep=!0;const n=a(r);fetch(r.href,n)}})();const X={n:8,slotCount:4,baseScale:2**10,modChain:[2**30,2**20]};function p(e,t){const a=e%t;return a<0?a+t:a}function O(e){return Array.from({length:e},()=>0)}function N(e,t){return Math.floor(Math.random()*(t-e+1))+e}function V(e,t){return Array.from({length:e},()=>N(0,t-1))}function R(e){return Array.from({length:e},()=>N(-1,1))}function q(e,t,a){return e.map((o,r)=>p(o+t[r],a))}function tt(e,t,a){return e.map((o,r)=>p(o-t[r],a))}function k(e,t,a,o){const r=O(a);for(let n=0;n<a;n+=1)for(let s=0;s<a;s+=1){const l=n+s;l<a?r[l]=p(r[l]+e[n]*t[s],o):r[l-a]=p(r[l-a]-e[n]*t[s],o)}return r}function D(e,t){const a=t<=65535?4:8;return e.map(o=>p(o,t).toString(16).padStart(a,"0")).join(" ")}function S(e,t){return Math.round(e*t)/t}function h(e,t=.55){return(Math.random()-.5)*t/Math.max(1,e)}class et{params=X;secretKey;constructor(){this.secretKey=R(this.params.n)}encode(t){const a=O(this.params.n),o=Math.min(this.params.slotCount,t.length);for(let r=0;r<o;r+=1)a[r]=Math.round(t[r]*this.params.baseScale);return a}decode(t,a,o){const r=[],n=Math.min(this.params.slotCount,a);for(let s=0;s<n;s+=1)r.push(t[s]/o);return r}encryptVector(t,a){const o=this.params.modChain[0],r=this.encode(t),n=V(this.params.n,o),s=R(this.params.n),l=k(n,this.secretKey.map(u=>p(u,o)),this.params.n,o),g=q(tt(r.map(u=>p(u,o)),l,o),s.map(u=>p(u,o)),o),f=Array.from({length:this.params.slotCount},(u,A)=>{const Q=A<t.length?t[A]:0;return S(Q,this.params.baseScale)+h(this.params.baseScale)});return{c0:g,c1:n,slots:f,scale:this.params.baseScale,level:this.params.modChain.length-1,encoding:`Delta=${this.params.baseScale}`,label:a,noiseBitsLost:0}}add(t,a,o){const r=this.params.modChain[Math.min(t.level,a.level)];return{c0:q(t.c0,a.c0,r),c1:q(t.c1,a.c1,r),slots:t.slots.map((n,s)=>S(n+a.slots[s],this.params.baseScale)+h(t.scale,.25)),scale:t.scale,level:Math.min(t.level,a.level),encoding:`Delta=${t.scale}`,label:o,noiseBitsLost:Math.max(t.noiseBitsLost,a.noiseBitsLost)}}multiply(t,a,o){const r=this.params.modChain[Math.min(t.level,a.level)],n=t.scale*a.scale;return{c0:k(t.c0,a.c0,this.params.n,r),c1:k(t.c1,a.c1,this.params.n,r),slots:t.slots.map((s,l)=>S(s*a.slots[l],n)+h(n,.9)),scale:n,level:Math.min(t.level,a.level),encoding:`Delta^2=${n}`,label:o,noiseBitsLost:Math.max(t.noiseBitsLost,a.noiseBitsLost)+1}}rescale(t,a){if(t.level===0)return{...t,label:`${a} (modulus exhausted)`};const o=t.level-1,r=this.params.modChain[o],n=this.params.baseScale;return{c0:t.c0.map(s=>p(Math.round(s/n),r)),c1:t.c1.map(s=>p(Math.round(s/n),r)),slots:t.slots.map(s=>S(s,this.params.baseScale)+h(this.params.baseScale,.7)),scale:this.params.baseScale,level:o,encoding:`Delta=${this.params.baseScale}`,label:a,noiseBitsLost:t.noiseBitsLost+1}}decryptVector(t,a){const o=Math.min(this.params.slotCount,a),r=t.noiseBitsLost/1024;return t.slots.slice(0,o).map(n=>n+h(t.scale,.35)+r*h(1,.6))}encryptFromPlainSlots(t,a,o,r){const n=this.params.modChain[a];return{c0:V(this.params.n,n),c1:V(this.params.n,n),slots:t.map(s=>S(s,this.params.baseScale)+h(this.params.baseScale,.6)),scale:this.params.baseScale,level:a,encoding:`Delta=${this.params.baseScale}`,label:r,noiseBitsLost:o}}formatCiphertext(t){const a=this.params.modChain[t.level],o=D(t.c0.slice(0,this.params.n),a),r=D(t.c1.slice(0,this.params.n),a);return`label=${t.label}
q=2^${Math.round(Math.log2(a))}, level=${t.level}, scale=${t.scale}
c0: ${o}
c1: ${r}`}slotError(t,a){return t.map((o,r)=>a[r]-o)}scientific(t){return t.toExponential(3)}preciseDigitsApprox(t){const a=Math.max(2,10-t.noiseBitsLost);return Math.max(1,Math.floor(a*Math.LOG10E*Math.log(2)))}}const i=new et,at=document.querySelector("#app");at.innerHTML=`
  <div class="app">
...
`;function G(){return document.documentElement.getAttribute("data-theme")==="light"?"light":"dark"}const P=document.querySelector("[data-theme-toggle]");function _(e){P.textContent=e==="dark"?"🌙":"☀️",P.setAttribute("aria-label",e==="dark"?"Switch to light mode":"Switch to dark mode")}function rt(e){document.documentElement.setAttribute("data-theme",e),localStorage.setItem("theme",e),_(e)}_(G());P.addEventListener("click",()=>{const e=G()==="dark"?"light":"dark";rt(e)});function x(e,t=4){const a=e.split(",").map(o=>Number(o.trim())).filter(o=>Number.isFinite(o)).slice(0,t);for(;a.length<t;)a.push(0);return a}function E(e){return`[${e.map(t=>t.toFixed(6)).join(", ")}]`}let L=null,B=null,$=null;const ot=document.querySelector("[data-e2-cta]"),nt=document.querySelector("[data-e2-ctb]"),it=document.querySelector("[data-e2-sum]"),C=document.querySelector("[data-e2-out]"),st=document.querySelector("[data-e2-scale]");document.querySelector("[data-e2-enc-a]").addEventListener("click",()=>{const e=x(document.getElementById("vec-a").value);L=i.encryptVector(e,"A"),ot.textContent=i.formatCiphertext(L),C.textContent=`A encoded slots: ${E(e)} using Delta=${i.params.baseScale}`});document.querySelector("[data-e2-enc-b]").addEventListener("click",()=>{const e=x(document.getElementById("vec-b").value);B=i.encryptVector(e,"B"),nt.textContent=i.formatCiphertext(B)});document.querySelector("[data-e2-add]").addEventListener("click",()=>{if(!L||!B){C.textContent="Encrypt A and B first.";return}$=i.add(L,B,"A+B"),it.textContent=i.formatCiphertext($),C.textContent="Ciphertext addition done for all 4 slots in one SIMD operation."});document.querySelector("[data-e2-dec]").addEventListener("click",()=>{if(!$){C.textContent="Add ciphertexts first.";return}const e=x(document.getElementById("vec-a").value),t=x(document.getElementById("vec-b").value),a=e.map((s,l)=>s+t[l]),o=i.decryptVector($,4),r=i.slotError(a,o);C.textContent=`Expected ${E(a)}
Actual ${E(o)}
Per-slot error ${r.map(s=>i.scientific(s)).join(", ")}
Approximation error is small and bounded by scale/noise settings.`;const n=i.params.baseScale;st.textContent=`Scale visualizer: 1.5 × ${n} = ${1.5*n}, 0.5 × ${n} = ${.5*n}, sum=${2*n}, decode=${2*n/n}.`});let M=null,K=null,c=null;const H=document.querySelector("[data-e3-ct]"),b=document.querySelector("[data-e3-out]");document.querySelector("[data-e3-enc]").addEventListener("click",()=>{const e=x(document.getElementById("mul-a").value,2),t=x(document.getElementById("mul-b").value,2);M=i.encryptVector(e,"mul-A"),K=i.encryptVector(t,"mul-B"),c=null,H.textContent=`ct(A):
${i.formatCiphertext(M)}

ct(B):
${i.formatCiphertext(K)}`,b.textContent="Encrypted A and B. Current scale=Delta."});document.querySelector("[data-e3-mul]").addEventListener("click",()=>{if(!M||!K){b.textContent="Encrypt A and B first.";return}c=i.multiply(M,K,"mul(A,B)"),H.textContent=i.formatCiphertext(c),b.textContent=`After multiplication: scale=${c.scale} (=Delta^2). Rescale required before further multiplications.`});document.querySelector("[data-e3-rescale]").addEventListener("click",()=>{if(!c){b.textContent="Run multiply first.";return}c=i.rescale(c,"rescaled(mul(A,B))"),H.textContent=i.formatCiphertext(c),b.textContent=`Rescale applied: scale reset to Delta=${i.params.baseScale}, level dropped to ${c.level}.`});document.querySelector("[data-e3-dec]").addEventListener("click",()=>{if(!c){b.textContent="Run multiply then rescale first.";return}const e=i.decryptVector(c,2);b.textContent=`Decrypted result ≈ ${E(e)}. Expected near [3.0, 8.1]. Small precision loss after rescaling is expected.`});const W=[[.5,-.3,.7,.2],[-.4,.8,.1,-.2]],j=[.1,-.05],U=[.6,-.7],z=.2;function lt(e){return Math.max(0,e)}function T(e){return .5+.197*e-.0035*e**3}function Y(e){const t=W.map((o,r)=>T(o.reduce((n,s,l)=>n+s*e[l],j[r]))),a=U.reduce((o,r,n)=>o+r*t[n],z);return{y:a,cls:a>.5?1:0}}const ct=document.querySelector("[data-e4-relu-table]");ct.innerHTML=[-1,-.5,0,.5,1,1.5].map(e=>`<tr><td>${e.toFixed(1)}</td><td>${lt(e).toFixed(4)}</td><td>${T(e).toFixed(4)}</td></tr>`).join("");const Z=Array.from(document.querySelectorAll("[data-x-slider]")),dt=Array.from(document.querySelectorAll("[data-x-val]"));function w(){return Z.map((e,t)=>{const a=Number(e.value);return dt[t].textContent=a.toFixed(1),a})}Z.forEach(e=>{e.addEventListener("input",()=>{w()})});let y=null,F=null;const v=document.querySelector("[data-e4-log]");document.querySelector("[data-e4-plain]").addEventListener("click",()=>{const e=w(),t=performance.now(),a=Y(e),o=performance.now()-t;v.textContent=`Plaintext inference
input=${E(e)}
output=${a.y.toFixed(6)}
class=${a.cls}
time=${o.toFixed(3)} ms`});document.querySelector("[data-e4-enc]").addEventListener("click",()=>{const e=w();y=i.encryptVector(e,"nn-input"),F=null,v.textContent=`Encrypted input ciphertext
${i.formatCiphertext(y)}`});document.querySelector("[data-e4-run]").addEventListener("click",()=>{if(!y){v.textContent="Encrypt inputs first.";return}const e=i.decryptVector(y,4),t=performance.now(),o=W.map((l,g)=>l.reduce((f,u,A)=>f+u*e[A],j[g])).map(l=>T(l)),r=U.reduce((l,g,f)=>l+g*o[f],z);F=i.encryptFromPlainSlots([r],Math.max(0,y.level-1),y.noiseBitsLost+3,"nn-output");const n=performance.now()-t,s=Math.max(100,n+120);v.textContent=`Encrypted inference (toy browser CKKS simulation)
...
Production note: CKKS inference is significantly slower than plaintext and can take seconds to minutes for large models.`});document.querySelector("[data-e4-dec]").addEventListener("click",()=>{if(!F){v.textContent="Run encrypted inference first.";return}const e=w(),t=Y(e),a=i.decryptVector(F,1)[0],o=a>.5?1:0;v.textContent+=`

Decrypt output ≈ ${a.toFixed(6)}
Plain output=${t.y.toFixed(6)}
Plain class=${t.cls}, Encrypted class=${o} (target: match)`});let d,m=0;const I=document.querySelector("[data-e5-log]");function J(){d=i.encryptVector([3.14159265358979],"pi"),m=0;const e=i.decryptVector(d,1)[0];I.textContent=`Start value: 3.14159265358979
After encrypt/decrypt: ${e.toPrecision(14)}
Approx correct digits: ${i.preciseDigitsApprox(d)}`}J();document.querySelector("[data-e5-reset]").addEventListener("click",J);document.querySelector("[data-e5-add]").addEventListener("click",()=>{const e=i.encryptVector([.125],`plus-${m}`);d=i.add(d,e,`e5-add-${m}`),m+=1;const t=i.decryptVector(d,1)[0];I.textContent+=`
After add: ${t.toPrecision(14)} | digits~${i.preciseDigitsApprox(d)}`});document.querySelector("[data-e5-mul]").addEventListener("click",()=>{const e=i.encryptVector([1.1],`mul-${m}`);d=i.rescale(i.multiply(d,e,`e5-mul-${m}`),`e5-rescale-${m}`),m+=1;const t=i.decryptVector(d,1)[0];I.textContent+=`
After multiply+rescale: ${t.toPrecision(14)} | digits~${i.preciseDigitsApprox(d)}`});
